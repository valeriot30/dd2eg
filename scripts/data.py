...
REPOS = [
    ...
    # --- Backend & Linguaggi di Programmazione (15) ---
    "python/cpython",
    "rust-lang/rust",
    "golang/go",
    "nodejs/node",
    ...
    # --- Intelligenza Artificiale & Data Science (20) ---
    "pytorch/pytorch",
    ...
    # --- Sistemi Operativi & Systems Programming (15) ---
    "torvalds/linux",
    "systemd/systemd",
    "freebsd/freebsd-src",
    "openbsd/src",
    ...
    # --- Varie / Alta Attività / Sicurezza (15) ---
    "home-assistant/core",
    "bitcoin/bitcoin",
